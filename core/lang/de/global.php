...
$_lang['templatecontroller'] = 'Vorlagencontroller';
...
$_lang["template_inuse"] = 'Diese Vorlage ist in Gebrauch. Bitte stellen Sie die Dokumente mithilfe der Vorlage auf eine andere Vorlage ein. Dokumente, die diese Vorlage verwenden:';
...
$_lang["role_no_tv"] = 'Dieser Rolle sind noch keine Variablen zugewiesen worden.';
$_lang["role_notassigned_tv"] = 'Diese Variablen sind für die Zuweisung verfügbar.';
$_lang["role_tv_msg"] = 'Die dieser Rolle zugewiesenen Variablen sind unten aufgeführt.';
...
$_lang["module_group_access_msg"] = 'Wählen Sie die Benutzergruppen aus, die dieses Modul innerhalb des EVO-Managers ausführen dürfen.';
...
$_lang["role_logout"] = 'Abmeldung aus dem EVO-Manager';
$_lang["role_list_module"] = 'Modul Liste';
...
$_lang["user_first_name"] = 'Vorname';
$_lang["user_last_name"] = 'Nachname';
$_lang["user_middle_name"] = 'Zweiter Vorname';
...
$_lang["no_user_role"] = 'Keine Benutzerrolle';
...
$_lang["user_verification"] = 'Benutzer ist verifiziert';
$_lang["user_zip"] = 'PLZ';
$_lang["username"] = 'Benutzername';
$_lang["username_unique"] = 'Benutzername ist bereits in Benutzung!';
...
$_lang["new_permission"] = 'Neue Berechtigung';
...
$_lang["manage_htmlsnippets"] = 'Chunks verwalten';
$_lang["manage_metatags"] = 'Meta-Angaben verwalten';
$_lang["manage_modules"] = 'Module verwalten';
$_lang["manage_plugins"] = 'Plugins verwalten';
$_lang["manage_snippets"] = 'Snippets verwalten';
$_lang["manage_templates"] = 'Templates verwalten';
$_lang["manage_documents"] = 'Dokumente verwalten';
$_lang["manage_permission"] = 'Berechtigungen verwalten';
...
$_lang["access_permissions_context"] = 'in Zusammenhang';
...
$_lang["access_permissions_user_toggle"] = 'Zugriffsberechtigungen umschalten';
...
$_lang["users_list"] = 'Liste der Benutzer';
$_lang["documents_list"] = 'Liste der Ressourcen';
...
$_lang["configcheck_lang_difference_msg"] = 'Die zur Zeit ausgewählte Sprache (Deutsch) enthält nicht die gleiche Anzahl an Einträgen wie die Standardsprache (Englisch). Dies stellt kein Problem für die Arbeit mit EVO dar, bedeutet jedoch, dass Sie die Sprachdatei aktualisieren sollten.';
...
$_lang["delete_yourself"] = 'Sie können sich nicht selbst löschen';
$_lang["delete_last_admin"] = 'Sie können den letzten Admin-Benutzer nicht löschen';

$_lang["confirm_delete_permission"] = 'Sind Sie sicher, dass Sie diese Berechtigung löschen möchten?';
...
$_lang["confirm_name_change"] = 'Die Änderung des Benutzernamens kann möglicherweise Auswirkungen auf die Funktion von Anwendungen Dritter haben, die Daten von EVO verwenden.\n\nSind Sie sicher, dass Sie den Benutzernamen ändern wollen?';
...
$_lang["email_unique"] = 'E-Mail wird bereits genutzt!';
...
$_lang["eventlog_msg"] = 'Informations-, Warn- und Fehlermeldungen des EVO-Managers werden im Systemereignisprotokoll gespeichert. Unter „Quelle“ ist das jeweils verursachende Modul angegeben.';
...
$_lang["friendlyurls_message"] = 'Diese Option erlaubt Ihnen die Benutzung benutzerfreundlicher URLs auf Apache-Webservern mit aktiviertem mod_rewrite oder auf dem IIS-Webserver mit entsprechenden Modulen. Öffnen sie bei EVO enthaltene .htaccess-Datei im Root-Verzeichnis für mehr Informationen.';
...
$_lang["login_message"] = 'Bitte melden Sie sich an, um mit EVO zu arbeiten.<br />Beachten Sie bei Ihrer Eingabe die Groß- und Kleinschreibung.';
...
$_lang["manager_lockout_message"] = '<p>Sie sind gegenwärtig im EVO-Manager angemeldet. Wenn Sie Ihre Login-Session beenden wollen, klicken Sie bitte den Abmelden-Button.</p><p>Um zu Ihrer Start- oder Home-Seite zu gelangen, klicken Sie bitte den Start-Button.';
$_lang["manager_permissions"] = 'Manager-Zugriffberechtigungen';
$_lang["manager_theme"] = 'Manager-Template';
$_lang["manager_theme_message"] = 'Wählen Sie das Template für den EVO-Manager aus.';
...
$_lang['manager_theme_mode_message'] = 'Diese Einstellung wird als "Standard" verwendet und kann vom Manager mit Hilfe der Schaltfläche zum Umschalten des Themenfarbmodus im Ressourcenbaum überschrieben werden: <i class="fa fa-lg fa-adjust"></i>';
...
$_lang["password_confirmed"] = 'Die Passwörter stimmen nicht überein';
...
$_lang["required_field"] = 'Feld: Feld ist erforderlich';
...
$_lang["manager_access_permissions"] = 'Manager-Zugriffsberechtigung';
$_lang["manage_groups"] = 'Dokumenten- und Benutzergruppen verwalten';
$_lang["manage_document_permissions"] = 'Dokumentberechtigungen verwalten';
...
$_lang["settings_title"] = 'Systemkonfiguration';
...
$_lang["controller_namespace"] = 'Controller Namensraum';
$_lang["controller_namespace_message"] = 'Geben Sie den vollständigen Namensraum an, aus dem es sich lohnt, Controller zu nehmen, zum Beispiel: <b>EvolutionCMS\\Main\\\Controllers\\</b>';
$_lang["update_repository"] = 'GitHub Repository-Pfad';
$_lang["update_repository_message"] = 'Geben Sie den Pfad zum GitHub-Repository ein, zum Beispiel: <b>evocms-community/evolution</b>';
...
$_lang["web_user_management_msg"] = 'Hier können Sie auswählen, welche Web-Benutzer Sie bearbeiten möchten. Web-Benutzer können sich nur an der Website anmelden, nicht jedoch im EVO-Manager.';
...
$_lang["a17_error_reporting_opt199"] = 'Alle erkennen';
...
$_lang["enable_filter_message"] = 'Filter ermöglichen es, Inhalte von EVO-Tags / TVs innerhalb Ihrer Templates dynamisch zu manipulieren, analog zu PHx. <a href="https://github.com/modxcms/evolution/issues/623" target="ext_help">Mehr Informationen</a>'; // todo: change link to documentation
$_lang["enable_filter_phx_warning"] = 'Bei aktiviertem PHx-Plugin sind die nativen EVO-Filter standardmäßig deaktiviert.';
...
$_lang["disable_chunk_cache_title"] = 'Chunk-Caching deaktivieren';
$_lang["disable_snippet_cache_title"] = 'Snippet-Caching deaktivieren';
$_lang["disable_plugins_cache_title"] = 'Plugin-Caching deaktivieren';
...
$_lang["error_parent_deleted"] = "Fehlgeschlagen, weil die übergeordnete Ressource gelöscht ist!";
...
$_lang["login_processor_verified"] = "Benutzerverifizierung erforderlich!";
...
$_lang["which_browser_msg"] = "Sie können einen Datei-Browser speziell für diesen Nutzer auswählen. &quot;Standard&quot; nutzt den in der EVO-Konfiguration gesetzten Standard Datei-Browser,";
...
$_lang['help_translating_title'] = "Helfen Sie, Evolution CMS zu übersetzen";
...
$_lang["login_form_style"] = 'Stil des Anmeldeformulars:';
$_lang["login_form_style_dark"] = 'dunkel';
$_lang["login_form_style_light"] = 'hell';
...
$_lang['chunk_processor'] = 'Chunks Verarbeitungsklasse';

$_lang["permission_title"] = 'Berechtigung erstellen/bearbeiten';
$_lang["groups_permission_title"] = 'Kategorie erstellen/bearbeiten';
$_lang["lang_key_desc"] = 'Key language from array $_lang';
$_lang["key_desc"] = 'Schlüssel für geprüfte Berechtigung';

$_lang["setting_from_file"] = '<strong class="text-danger">Der Parameterwert ist in core/custom/config/cms/settings definiert.</strong>';
