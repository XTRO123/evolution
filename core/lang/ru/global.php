...
$_lang['templatecontroller'] = 'Контроллер шаблона';
...
$_lang["template_inuse"] = 'Этот шаблон используется. Пожалуйста, выберите другой шаблон для следующих документов:';
...
$_lang["access_permissions_user_toggle"] = 'Изменить все разрешения';
...
$_lang["configcheck_filemanager_path"] = 'Указан неверный <a href="/[+MGR_DIR+]/?a=17&amp;tab=4">путь для файлового менеджера</a>';
...
$_lang["configcheck_rb_base_dir"] = 'Указан неверный <a href="/[+MGR_DIR+]/?a=17&amp;tab=4">путь для файл-браузера</a>';
...
$_lang["safe_mode_warning"] = 'Включен безопасный режим. Функциональность панели управления ограничена.';
...
$_lang["credits_shouts_msg"] = '<p>Evolution CMS поддерживается на сайте <a href="https://evocms.ru/" target="_blank">evocms.ru</a>.</p>';
...
$_lang["alias_listing_title"] = 'Кэширование карты ссылок';
$_lang["alias_listing_message"] = 'Кэширование карты ссылок, должно быть отключено на сайтах с очень большим количеством документов, чтобы уменьшить потребление памяти.';
$_lang["alias_listing_disabled"] = 'Отключено';
$_lang["alias_listing_folders"] = 'Только для папок';
$_lang["alias_listing_enabled"] = 'Включено';
...
$_lang["login_processor_verified"] = "Аккаунт пользователя не подтвержден!";
...
$_lang['email_sender_method_message'] = 'Адрес возврата сообщения. Используется в заголовке Return-Path и определяет адрес, на который будут отправлены сообщения о невозможности доставки. Автоопределение будет работать в большинстве случаев.';
...
$_lang["key_desc"] = 'Ключ для проверки доступа';
